...
- [ ] Persona discussed: [Persona 2 (Johan)]
- [ ] Design artefacts reviewed: [Wireframe]
- [ ] Issues discussed: []
- [ ] Feedback provided: [- Layout is simple
- - Utilises dropdown makes for good mvp impl
- - saving in-built os menu with integrate well with existing tools
- - could get exact time to transcribe text (already have that in basic lib so just import that in to file that will utilise it)
- - Shy away from keybinds]
...
- [Y ] Persona is well defined
- [ Y] Persona is relevant to the application
- [Y ] Design artifacts are present and easy to follow
- [ Y] Design decisions are based on user needs and goals
- [Y ] Appropriate considerations of interaction patterns appropriate for the user
- [ NA] Efforts towards realizing at least one significant issue involving user interaction
- [ Y] Whole team engagement in the design process
